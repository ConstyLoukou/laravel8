...
@section('contenu')
    ...
    {{--<form action="{{url('/saveetudiant')}}" method="POST" class="form-horizontal">--}}
        {!!Form::open(['action' => 'App\Http\Controllers\PagesController@saveetudiant', 'method' => 'POST', 'class' => 'form-horizontal'])!!}
        {{csrf_field()}}
        <fieldset>
            <legend style="text-align: center">Ajouter un Etudiant</legend>
           ...
           {{--<input type="text" name="etud_number" id="diplome" class="form-control" placeholder="Votre Numero" required>--}}
            ...
            <section class="form_group">
            <input type="submit" name="Envoyer" value="Ajouter Etudiant" class="btn btn-primary">
            {{--Form::submit('', 'submit', ['class' => 'btn btn-primary'])--}}
            </section>
        </fieldset>
    </form><br>
    <h3>Vous avez un compte ? <a href="/"> Connectez-vous</a></h3>
    </section>
